        ...
        <main>
            <form>
                <div class = 'inputs'>
                    ...
                    <input id="checkboxid" type="checkbox" class="css-checkbox specialCheck" name = "cookTime" value = "30"><label for="checkboxid" class="css-label"
                    <?php if($cookTime) echo " checked" ?>
                    ></label>
                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <?php 
                                ...
                                {
                                    echo '<button type="button" class="btn btn-secondary" id="logInMessageButton">Log in to save recipe</button>';
                                }
                            ?>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <!-- Log in error messagage (if wrong credentials) -->
                            <div id="logInVerification"></div> 
                            <!-- Sample users information div -->
                            <div style="color:blue;font-size:14px;padding-bottom:16px">
                                For testing purposes you can use one of these accounts:<br/>
                                user_1, cst336 <br/>
                                user_2, cst336 <br/>
                                user_3, cst336 <br/>
                            </div>
